            ...
            <div class="col-xl-8 col-lg-7">
                ...
                <div class="card mb-4">
                    <div class="card-header border-bottom d-flex align-items-center">
                        <i class='bx bx-edit me-2 fs-4 text-primary'></i>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="kupon_kodu" id="kuponKoduInput" class="form-control text-uppercase" 
                                           value="{{ old('kupon_kodu', $kupon->kupon_kodu) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="baslik" class="form-control" 
                                       value="{{ old('baslik', $kupon->baslik) }}" required>
                            </div>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-bold">Açıklama</label>
                            <textarea name="aciklama" class="form-control" rows="2">{{ old('aciklama', $kupon->aciklama) }}</textarea>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <select name="indirim_tipi" id="indirimTipi" class="form-select" required>
                                    <option value="yuzde" {{ old('indirim_tipi', $kupon->indirim_tipi) == 'yuzde' ? 'selected' : '' }}>Yüzde (%)</option>
                                    <option value="tutar" {{ old('indirim_tipi', $kupon->indirim_tipi) == 'tutar' ? 'selected' : '' }}>Sabit Tutar (₺)</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" name="indirim_miktari" class="form-control" step="0.01" min="0"
                                           value="{{ old('indirim_miktari', $kupon->indirim_miktari) }}" required>
                            ...
                            <div class="col-md-4" id="maksimumIndirimDiv">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="maksimum_indirim" class="form-control" step="0.01" min="0"
                                           value="{{ old('maksimum_indirim', $kupon->maksimum_indirim) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="kullanici_basina_limit" class="form-control" min="1"
                                       value="{{ old('kullanici_basina_limit', $kupon->kullanici_basina_limit) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" name="baslangic_tarihi" class="form-control" 
                                       value="{{ old('baslangic_tarihi', \Carbon\Carbon::parse($kupon->baslangic_tarihi)->format('Y-m-d\TH:i')) }}" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" name="bitis_tarihi" class="form-control" 
                                       value="{{ old('bitis_tarihi', \Carbon\Carbon::parse($kupon->bitis_tarihi)->format('Y-m-d\TH:i')) }}" required>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body pt-4">
                        <div class="alert alert-info d-flex align-items-center" role="alert">
                            ...
                            <div>Bu alanları boş bırakırsanız kupon <strong>tüm ürünlerde</strong> geçerli olur.</div>
                        </div>

                        @php
                            $hedefKat = is_string($kupon->hedef_kategoriler) ? json_decode($kupon->hedef_kategoriler, true) : $kupon->hedef_kategoriler;
                            $hedefUrun = is_string($kupon->hedef_urunler) ? json_decode($kupon->hedef_urunler, true) : $kupon->hedef_urunler;
                            $haricKat = is_string($kupon->haric_kategoriler) ? json_decode($kupon->haric_kategoriler, true) : $kupon->haric_kategoriler;
                            $haricUrun = is_string($kupon->haric_urunler) ? json_decode($kupon->haric_urunler, true) : $kupon->haric_urunler;
                        @endphp
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="hedef_kategoriler[]" class="form-select" multiple size="5">
                                    @foreach($kategoriler as $kategori)
                                        <option value="{{ $kategori->id }}" {{ in_array($kategori->id, $hedefKat ?? []) ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="hedef_urunler[]" class="form-select" multiple size="5">
                                    @foreach($urunler as $urun)
                                        <option value="{{ $urun->id }}" {{ in_array($urun->id, $hedefUrun ?? []) ? 'selected' : '' }}>
                                            {{ $urun->urun_ad }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select name="haric_kategoriler[]" class="form-select" multiple size="5">
                                    @foreach($kategoriler as $kategori)
                                        <option value="{{ $kategori->id }}" {{ in_array($kategori->id, $haricKat ?? []) ? 'selected' : '' }}>
                                            {{ $kategori->kategori_ad }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="haric_urunler[]" class="form-select" multiple size="5">
                                    @foreach($urunler as $urun)
                                        <option value="{{ $urun->id }}" {{ in_array($urun->id, $haricUrun ?? []) ? 'selected' : '' }}>
                                            {{ $urun->urun_ad }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="kupon_turu" id="kuponTuru" class="form-select form-select-lg" required>
                                <option value="genel" {{ old('kupon_turu', $kupon->kupon_turu) == 'genel' ? 'selected' : '' }}>
                                    🌍 Genel
                                </option>
                                <option value="kullanici_ozel" {{ old('kupon_turu', $kupon->kupon_turu) == 'kullanici_ozel' ? 'selected' : '' }}>
                                    👤 Özel - Seçili Kullanıcılar
                                </option>
                                <option value="kural_bazli" {{ old('kupon_turu', $kupon->kupon_turu) == 'kural_bazli' ? 'selected' : '' }}>
                        ...
                        <div id="kullaniciOzelSection" class="p-3 border rounded bg-light mb-3" style="display: none;">
                            ...
                            <div class="mb-2">
                                ...
                                <div id="selectedUsers" class="d-flex flex-wrap gap-2 p-2 border rounded bg-white" style="min-height: 50px; max-height: 200px; overflow-y: auto;">
                                    @if($kupon->kupon_turu == 'kullanici_ozel' && isset($atananKullanicilar))
                                        @foreach($atananKullanicilar as $user)
                                            <div class="badge bg-primary d-flex align-items-center gap-2" data-user-id="{{ $user->id }}">
                                                {{ $user->name }}
                                                <i class='bx bx-x fs-6' onclick="kullaniciKaldir({{ $user->id }})" style="cursor: pointer;"></i>
                        ...
                        @php
                            $kosullar = is_string($kupon->kural_kosullari) ? json_decode($kupon->kural_kosullari, true) : ($kupon->kural_kosullari ?? []);
                        @endphp
                        ...
                        <div id="kuralBazliSection" style="display: none;">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" name="kural_tarih_araligi" class="form-control" 
                                           value="{{ old('kural_tarih_araligi', $kosullar['tarih_araligi'] ?? 30) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="kural_min_siparis_tutari" class="form-control" 
                                           value="{{ old('kural_min_siparis_tutari', $kosullar['min_siparis_tutari'] ?? '') }}">
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="kural_min_siparis_adedi" class="form-control" 
                                       value="{{ old('kural_min_siparis_adedi', $kosullar['min_siparis_adedi'] ?? '') }}">
                            </div>

                            <div class="d-flex flex-column gap-2 mt-3 p-2 bg-light rounded">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="kural_ilk_alisveris" value="1" id="kuralIlkAlisveris" 
                                        {{ old('kural_ilk_alisveris', $kosullar['ilk_alisveris'] ?? false) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="kuralIlkAlisveris">🎉 İlk Alışveriş Yapacaklar</label>
                                </div>

                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="kural_dogum_gunu" value="1" id="kuralDogumGunu"
                                        {{ old('kural_dogum_gunu', $kosullar['dogum_gunu'] ?? false) ? 'checked' : '' }}>
                                ...
                                <div id="dogumGunuAyarlari" class="ms-4 mb-2" style="display: none;">
                                    <div class="input-group input-group-sm">
                                        <input type="number" name="kural_dogum_gunu_aralik" class="form-control" 
                                            value="{{ old('kural_dogum_gunu_aralik', $kosullar['dogum_gunu_aralik'] ?? 7) }}">
                                        <span class="input-group-text">gün önce</span>
                                    </div>
                                </div>

                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="kural_inaktif_musteri" value="1" id="kuralInaktif"
                                        {{ old('kural_inaktif_musteri', $kosullar['inaktif_musteri'] ?? false) ? 'checked' : '' }}>
                                ...
                                <div id="inaktifAyarlari" class="ms-4 mb-2" style="display: none;">
                                    <div class="input-group input-group-sm">
                                        <input type="number" name="kural_inaktif_gun" class="form-control" 
                                            value="{{ old('kural_inaktif_gun', $kosullar['inaktif_gun'] ?? 60) }}">
                            ...
                            <div class="alert alert-secondary mt-3 p-3 mb-0 border-primary border-1">
                                <div class="form-check form-switch mb-0">
                                    <input class="form-check-input" type="checkbox" name="otomatik_ata" value="1" id="otomatikAta" 
                                        {{ old('otomatik_ata', $kupon->otomatik_ata) ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" name="aktif" value="1" id="statusSwitch" {{ old('aktif', $kupon->aktif) ? 'checked' : '' }}>
...
function kullaniciKaldir(userId) {
    ...
    const selectedUsersDiv = document.getElementById('selectedUsers');
    if(selectedUsersDiv.children.length <= 1) {
         const noUserSpan = document.getElementById('noUserSelected');
